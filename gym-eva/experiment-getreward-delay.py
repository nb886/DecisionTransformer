...
from d_mindformer.evaluation.evaluate_episodes_stop_early import (
    evaluate_episode,
...
def experiment(
    ...
    if model_type == "dt":
        trainer = SequenceTrainer(  # SequenceTrainer只比较actions 把model和 optiminzer scheduler 打包
            ...
            #     (r_hat - r) ** 2),
            loss_fn=lambda reward_hat, a_hat, r_hat, reward, a, r: 1
            * F.smooth_l1_loss(a_hat, a, reduction="mean")
