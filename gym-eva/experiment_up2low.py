...
from d_mindformer.training.seq_trainer_new import SequenceTrainer
...
def experiment(
    ...
    def get_batch(batch_size=256,
        ...
        # pct_traj = iter_num/variant['max_iters']
        # pct_traj = 1
        # print(pct_traj)
        if iter_num < 20:
            pct_traj = iter_num/20
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pct_traj', type=float, default=0.1)
